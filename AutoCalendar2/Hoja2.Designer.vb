...
Partial Public NotInheritable Class Hoja2
    ...
    Public Sub New(ByVal factory As Global.Microsoft.Office.Tools.Excel.Factory, ByVal serviceProvider As Global.System.IServiceProvider)
        MyBase.New(factory, serviceProvider, "Hoja2", "Hoja2")
    End Sub
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _Hoja2 As Hoja2

    Friend Shared Property Hoja2() As Hoja2
        Get
            Return _Hoja2
        End Get
        Set(value As Hoja2)
            If (_Hoja2 Is Nothing) Then
                _Hoja2 = value
            Else
